...
GOOGLE_CLIENT_SECRET_MOBILE = os.getenv("GOOGLE_CLIENT_SECRET_MOBILE")

SPOTIFY_CLIENT_ID = os.getenv("SPOTIFY_CLIENT_ID")
SPOTIFY_CLIENT_SECRET = os.getenv("SPOTIFY_CLIENT_SECRET")
SPOTIFY_CLIENT_ID_MOBILE = os.getenv("SPOTIFY_CLIENT_ID_MOBILE")
SPOTIFY_CLIENT_SECRET_MOBILE = os.getenv("SPOTIFY_CLIENT_SECRET_MOBILE")
