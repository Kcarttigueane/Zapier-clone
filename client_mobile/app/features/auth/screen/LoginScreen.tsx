...
import { Image, SafeAreaView, StyleSheet, Pressable, ScrollView } from 'react-native';
...
const LoginScreen = ({ navigation }: LoginScreenProps) => {
  const { loginFn, loginWithGoogle, loginWithSpotify, loginWithGitHub } = useAuthStore(state => state);
